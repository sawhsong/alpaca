...
public class HpElementValuesD extends BaseDto implements Serializable {
	/**
	 * Columns
	 */
	private double elementValueId;
	private String ELEMENT_VALUE_ID;
	...
	public HpElementValuesD() throws Exception {
		Class cls = getClass();
		...
		setFrwVarPrimaryKey("ELEMENT_VALUE_ID,FROM_DATE,TO_DATE");
		setFrwVarDateColumn("FROM_DATE,TO_DATE");
		setFrwVarNumberColumn("ELEMENT_VALUE_ID,ASG_ELEMENT_ID,ELEMENT_ATT_ID");
		setFrwVarClobColumn("");
	 ...
	 * Accessors
	 */
	public double getElementValueId() {
		return elementValueId;
	}

	public void setElementValueId(double elementValueId) throws Exception {
		this.elementValueId = elementValueId;
		setValueFromAccessor("ELEMENT_VALUE_ID", CommonUtil.toString(elementValueId));
	}
	...
	public void setEntryValue(String entryValue) throws Exception {
		this.entryValue = entryValue;
		setValueFromAccessor("ENTRY_VALUE", entryValue);
	}
	...
	public boolean equals(Object object) {
		if (!(object instanceof HpElementValuesD)) {
			return false;
		}
		return true;
	}
	...
	public String toXmlString() {
		...
		str += "<column name=\"elementValueId\" value=\""+elementValueId+"\">";
		...
		str += "<column name=\"entryValue\" value=\""+entryValue+"\">";
