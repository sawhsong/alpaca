...
public class HpBillingCodePeriods extends BaseDto implements Serializable {
	/**
	 * Columns
	 */
	...
	public HpBillingCodePeriods() throws Exception {
		Class cls = getClass();
		...
		setFrwVarPrimaryKey("PERIOD_ID");
		setFrwVarDateColumn("END_DATE,START_DATE,CHECK_DATE");
		setFrwVarNumberColumn("PERIOD_ID,BILLING_CODE_ID");
		setFrwVarClobColumn("");
	...
	public void setCheckDate(Date checkDate) throws Exception {
		this.checkDate = checkDate;
		setValueFromAccessor("CHECK_DATE", CommonUtil.toString(checkDate));
	}
	...
	public String toXmlString() {
		...
		str += "<column name=\"checkDate\" value=\""+checkDate+"\">";
