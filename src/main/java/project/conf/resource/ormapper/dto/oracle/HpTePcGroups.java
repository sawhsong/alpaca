...
public class HpTePcGroups extends BaseDto implements Serializable {
	/**
	 * Columns
	 */
	...
	private double pcPersonId;
	private String PC_PERSON_ID;
	...
	public HpTePcGroups() throws Exception {
		Class cls = getClass();
		...
		setFrwVarPrimaryKey("GROUP_ID");
		setFrwVarDateColumn("CREATION_DATE,LAST_UPDATE_DATE");
		setFrwVarNumberColumn("GROUP_ID,BUSINESS_GROUP_ID,CREATED_BY,LAST_UPDATED_BY,PC_PERSON_ID");
		setFrwVarClobColumn("");
	...
	public double getPcPersonId() {
		return pcPersonId;
	}

	public void setPcPersonId(double pcPersonId) throws Exception {
		this.pcPersonId = pcPersonId;
		setValueFromAccessor("PC_PERSON_ID", CommonUtil.toString(pcPersonId));
	}
	...
	public String toXmlString() {
		...
		str += "<column name=\"pcPersonId\" value=\""+pcPersonId+"\">";
