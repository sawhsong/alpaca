...
public class OrganisationRole extends BaseDto implements Serializable {
	/**
	 * Columns
	 */
	...
	private double organisationRoleId;
	private String ORGANISATION_ROLE_ID;
	...
	public OrganisationRole() throws Exception {
		Class cls = getClass();
		...
		setFrwVarPrimaryKey("");
		setFrwVarDateColumn("");
		setFrwVarNumberColumn("ORGANISATION_ID,ORGANISATION_ROLE_ID");
		setFrwVarClobColumn("");
	...
	public double getOrganisationRoleId() {
		return organisationRoleId;
	}

	public void setOrganisationRoleId(double organisationRoleId) throws Exception {
		this.organisationRoleId = organisationRoleId;
		setValueFromAccessor("ORGANISATION_ROLE_ID", CommonUtil.toString(organisationRoleId));
	}
	...
	public String toString() {
		...
		str += "organisationRoleId : "+organisationRoleId+"\n";
	...
	public String toXmlString() {
		...
		str += "<column name=\"organisationRoleId\" value=\""+organisationRoleId+"\">";
