...
public class HpAsgSet extends BaseDto implements Serializable {
	/**
	 * Columns
	 */
	private double assignmentSetId;
	private String ASSIGNMENT_SET_ID;
	private double billingCode;
	...
	private String ASSIGNMENT_SET_NAME;
	...
	public HpAsgSet() throws Exception {
		Class cls = getClass();
		...
		setFrwVarPrimaryKey("ASSIGNMENT_SET_ID");
		setFrwVarDateColumn("CREATION_DATE,LAST_UPDATE_DATE");
		setFrwVarNumberColumn("ASSIGNMENT_SET_ID,BILLING_CODE,BUSINESS_GROUP_ID,CREATED_BY,LAST_UPDATED_BY,BILLING_CODE_ID");
		setFrwVarClobColumn("");
	...
	public double getBillingCode() {
		return billingCode;
	}

	public void setBillingCode(double billingCode) throws Exception {
		this.billingCode = billingCode;
		setValueFromAccessor("BILLING_CODE", CommonUtil.toString(billingCode));
	}
	...
	public void setAssignmentSetName(String assignmentSetName) throws Exception {
		this.assignmentSetName = assignmentSetName;
		setValueFromAccessor("ASSIGNMENT_SET_NAME", assignmentSetName);
	}
	...
	public String toString() {
		...
		str += "assignmentSetName : "+assignmentSetName+"\n";
	...
	public String toXmlString() {
		...
		str += "<column name=\"assignmentSetName\" value=\""+assignmentSetName+"\">";
