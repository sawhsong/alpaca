...
public class PrtCohOrgLink extends BaseDto implements Serializable {
	/**
	 * Columns
	 */
	private double organisationId;
	private String ORGANISATION_ID;
	private double prtCohOrgLinkId;
	private String PRT_COH_ORG_LINK_ID;
	...
	public PrtCohOrgLink() throws Exception {
		Class cls = getClass();
		...
		setFrwVarPrimaryKey("PRT_COH_ORG_LINK_ID");
		setFrwVarDateColumn("");
		setFrwVarNumberColumn("ORGANISATION_ID,PRT_COH_ORG_LINK_ID,PRT_COH_SCENARIO_ID");
		setFrwVarClobColumn("");
	...
	public double getPrtCohOrgLinkId() {
		return prtCohOrgLinkId;
	}

	public void setPrtCohOrgLinkId(double prtCohOrgLinkId) throws Exception {
		this.prtCohOrgLinkId = prtCohOrgLinkId;
		setValueFromAccessor("PRT_COH_ORG_LINK_ID", CommonUtil.toString(prtCohOrgLinkId));
	}
	...
	public String toString() {
		...
		str += "prtCohOrgLinkId : "+prtCohOrgLinkId+"\n";
	...
	public String toXmlString() {
		...
		str += "<column name=\"prtCohOrgLinkId\" value=\""+prtCohOrgLinkId+"\">";
