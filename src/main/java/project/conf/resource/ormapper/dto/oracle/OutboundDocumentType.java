...
public class OutboundDocumentType extends BaseDto implements Serializable {
	/**
	 * Columns
	 */
	...
	private double outboundDocumentTypeId;
	private String OUTBOUND_DOCUMENT_TYPE_ID;
	private String type;
	private String TYPE;
	...
	public OutboundDocumentType() throws Exception {
		Class cls = getClass();
		...
		setFrwVarNumberColumn("CREATED_BY,OUTBOUND_DOCUMENT_TYPE_ID,UPDATED_BY");
		setFrwVarClobColumn("");
	...
	public double getOutboundDocumentTypeId() {
		return outboundDocumentTypeId;
	}

	public void setOutboundDocumentTypeId(double outboundDocumentTypeId) throws Exception {
		this.outboundDocumentTypeId = outboundDocumentTypeId;
		setValueFromAccessor("OUTBOUND_DOCUMENT_TYPE_ID", CommonUtil.toString(outboundDocumentTypeId));
	}
	...
	public void setShortName(String shortName) throws Exception {
		...
		setValueFromAccessor("SHORT_NAME", shortName);
	}
	...
	public String toString() {
		...
		str += "outboundDocumentTypeId : "+outboundDocumentTypeId+"\n";
		str += "type : "+type+"\n";
	...
	public String toXmlString() {
		...
		str += "<column name=\"outboundDocumentTypeId\" value=\""+outboundDocumentTypeId+"\">";
		str += "<column name=\"type\" value=\""+type+"\">";
		str += "<column name=\"createdDate\" value=\""+createdDate+"\">";
		str += "<column name=\"shortName\" value=\""+shortName+"\">";
