...
public class HpAdditionalServices extends BaseDto implements Serializable {
	/**
	 * Columns
	 */
	private double addServiceId;
	private String ADD_SERVICE_ID;
	...
	private double serviceProviderId;
	...
	public HpAdditionalServices() throws Exception {
		Class cls = getClass();
		...
		setFrwVarPrimaryKey("ADD_SERVICE_ID");
		setFrwVarDateColumn("CREATION_DATE,LAST_UPDATE_DATE,REFERRAL_DATE");
		setFrwVarNumberColumn("ADD_SERVICE_ID,CREATED_BY,LAST_UPDATED_BY,PERSON_ID,BUSINESS_GROUP_ID,COMMENT_ID,ENTITY_EMPLOYEE_ID,SERVICE_PROVIDER_ID");
		setFrwVarClobColumn("");
	 ...
	 * Accessors
	 */
	public double getAddServiceId() {
		return addServiceId;
	}

	public void setAddServiceId(double addServiceId) throws Exception {
		this.addServiceId = addServiceId;
		setValueFromAccessor("ADD_SERVICE_ID", CommonUtil.toString(addServiceId));
	}
	...
	public void setReferralDate(Date referralDate) throws Exception {
		this.referralDate = referralDate;
		setValueFromAccessor("REFERRAL_DATE", CommonUtil.toString(referralDate));
	}

	public double getServiceProviderId() {
		return serviceProviderId;
	}

	public void setServiceProviderId(double serviceProviderId) throws Exception {
		this.serviceProviderId = serviceProviderId;
		setValueFromAccessor("SERVICE_PROVIDER_ID", CommonUtil.toString(serviceProviderId));
	}
	...
	public String toString() {
		...
		str += "referralDate : "+referralDate+"\n";
		str += "serviceProviderId : "+serviceProviderId+"\n";
	...
	public String toXmlString() {
		...
		str += "<column name=\"addServiceId\" value=\""+addServiceId+"\">";
		...
		str += "<column name=\"referralDate\" value=\""+referralDate+"\">";
		str += "<column name=\"serviceProviderId\" value=\""+serviceProviderId+"\">";
