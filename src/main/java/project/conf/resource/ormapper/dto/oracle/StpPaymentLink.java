...
public class StpPaymentLink extends BaseDto implements Serializable {
	/**
	 * Columns
	 */
	...
	public StpPaymentLink() throws Exception {
		Class cls = getClass();
		...
		setFrwVarNumberColumn("BUSINESS_GROUP_ID,CREATED_BY,FILE_ID,LAST_UPDATED_BY,LINK_ID,PAYMENT_ID");
		setFrwVarClobColumn("");
