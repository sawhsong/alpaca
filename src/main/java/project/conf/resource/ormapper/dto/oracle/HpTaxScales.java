...
public class HpTaxScales extends BaseDto implements Serializable {
	/**
	 * Columns
	 */
	...
	private String taxScaleName;
	private String TAX_SCALE_NAME;
	...
	public HpTaxScales() throws Exception {
		Class cls = getClass();
		...
		setFrwVarPrimaryKey("TAX_SCALE_ID");
		setFrwVarDateColumn("CREATION_DATE,END_DATE,LAST_UPDATE_DATE,START_DATE");
		setFrwVarNumberColumn("TAX_SCALE_ID,CREATED_BY,LAST_UPDATED_BY");
		setFrwVarClobColumn("");
	...
	public String getTaxScaleName() {
		return taxScaleName;
	}

	public void setTaxScaleName(String taxScaleName) throws Exception {
		this.taxScaleName = taxScaleName;
		setValueFromAccessor("TAX_SCALE_NAME", taxScaleName);
	}
	...
	public String toXmlString() {
		...
		str += "<column name=\"taxScaleName\" value=\""+taxScaleName+"\">";
