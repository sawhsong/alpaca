...
public class SysMenus extends BaseDto implements Serializable {
	/**
	 * Columns
	 */
	...
	public SysMenus() throws Exception {
		Class cls = getClass();
		...
		setFrwVarNumberColumn("MENU_ID,CREATED_BY,LAST_UPDATED_BY");
		setFrwVarClobColumn("");
	...
	public void setMenuName(String menuName) throws Exception {
		...
		setValueFromAccessor("MENU_NAME", menuName);
	}
	...
	public void setMenuType(String menuType) throws Exception {
		this.menuType = menuType;
		setValueFromAccessor("MENU_TYPE", menuType);
	}
	...
	public void setUserMenuName(String userMenuName) throws Exception {
		this.userMenuName = userMenuName;
		setValueFromAccessor("USER_MENU_NAME", userMenuName);
	}
	...
	public String toString() {
		...
		str += "menuName : "+menuName+"\n";
		str += "description : "+description+"\n";
		str += "fromDate : "+fromDate+"\n";
		str += "menuType : "+menuType+"\n";
		str += "toDate : "+toDate+"\n";
		str += "userMenuName : "+userMenuName+"\n";
	...
	public String toXmlString() {
		...
		str += "<column name=\"menuName\" value=\""+menuName+"\">";
		str += "<column name=\"description\" value=\""+description+"\">";
		str += "<column name=\"fromDate\" value=\""+fromDate+"\">";
		str += "<column name=\"menuType\" value=\""+menuType+"\">";
		str += "<column name=\"toDate\" value=\""+toDate+"\">";
		str += "<column name=\"userMenuName\" value=\""+userMenuName+"\">";
