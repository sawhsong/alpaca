...
public class TimesheetAuthEmailLink extends BaseDto implements Serializable {
	/**
	 * Columns
	 */
	...
	public TimesheetAuthEmailLink() throws Exception {
		Class cls = getClass();
		...
		setFrwVarDateColumn("");
		setFrwVarNumberColumn("LINK_ID,APPROVER_ID,TIMESHEET_ID");
		setFrwVarClobColumn("");
