...
public class QuartzJobLog extends BaseDto implements Serializable {
	/**
	 * Columns
	 */
	...
	public QuartzJobLog() throws Exception {
		Class cls = getClass();
		...
		setFrwVarPrimaryKey("");
		setFrwVarDateColumn("RUN_DATE");
		setFrwVarNumberColumn("JOB_ID,LOG_ID,RUN_BY");
		setFrwVarClobColumn("");
	...
	public void setParamteres(String paramteres) throws Exception {
		this.paramteres = paramteres;
		setValueFromAccessor("PARAMTERES", paramteres);
	}

	public double getRunBy() {
		return runBy;
	}

	public void setRunBy(double runBy) throws Exception {
		this.runBy = runBy;
		setValueFromAccessor("RUN_BY", CommonUtil.toString(runBy));
	}
	...
	public void setRunDate(Date runDate) throws Exception {
		...
		setValueFromAccessor("RUN_DATE", CommonUtil.toString(runDate));
	}
	...
	public String toXmlString() {
		...
		str += "<column name=\"paramteres\" value=\""+paramteres+"\">";
		str += "<column name=\"runBy\" value=\""+runBy+"\">";
		str += "<column name=\"runDate\" value=\""+runDate+"\">";
