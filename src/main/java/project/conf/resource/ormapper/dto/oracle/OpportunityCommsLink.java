...
public class OpportunityCommsLink extends BaseDto implements Serializable {
	/**
	 * Columns
	 */
	...
	public OpportunityCommsLink() throws Exception {
		Class cls = getClass();
		...
		setFrwVarPrimaryKey("");
		setFrwVarDateColumn("");
		setFrwVarNumberColumn("CONTACT_ID,LINK_ID,OPPORTUNITY_ID");
		setFrwVarClobColumn("");
