...
public class CrmStage extends BaseDto implements Serializable {
	/**
	 * Columns
	 */
	...
	private String OUTCOME;
	private double representative1;
	private String REPRESENTATIVE1;
	private double representative2;
	...
	public CrmStage() throws Exception {
		Class cls = getClass();
		...
		setFrwVarPrimaryKey("STAGE_ID");
		setFrwVarDateColumn("CREATION_DATE,LAST_UPDATE_DATE,END_DATE,START_DATE");
		setFrwVarNumberColumn("STAGE_ID,ORGANISATION_ID,CREATED_BY,LAST_UPDATED_BY,BUSINESS_GROUP_ID,REPRESENTATIVE1,REPRESENTATIVE2");
		setFrwVarClobColumn("");
	...
	public void setStageId(double stageId) throws Exception {
		this.stageId = stageId;
		setValueFromAccessor("STAGE_ID", CommonUtil.toString(stageId));
	}
	...
	public void setStage(String stage) throws Exception {
		this.stage = stage;
		setValueFromAccessor("STAGE", stage);
	}
	...
	public void setOutcome(String outcome) throws Exception {
		...
		setValueFromAccessor("OUTCOME", outcome);
	}

	public double getRepresentative1() {
		return representative1;
	}

	public void setRepresentative1(double representative1) throws Exception {
		this.representative1 = representative1;
		setValueFromAccessor("REPRESENTATIVE1", CommonUtil.toString(representative1));
	}

	public double getRepresentative2() {
		return representative2;
	}

	public void setRepresentative2(double representative2) throws Exception {
		this.representative2 = representative2;
		setValueFromAccessor("REPRESENTATIVE2", CommonUtil.toString(representative2));
	}
	...
	public String toString() {
		...
		str += "notes : "+notes+"\n";
		str += "outcome : "+outcome+"\n";
		str += "representative1 : "+representative1+"\n";
		str += "representative2 : "+representative2+"\n";
	...
	public String toXmlString() {
		...
		str += "<column name=\"outcome\" value=\""+outcome+"\">";
		str += "<column name=\"representative1\" value=\""+representative1+"\">";
		str += "<column name=\"representative2\" value=\""+representative2+"\">";
