...
public class AsgDeliverablesAuthEmail extends BaseDto implements Serializable {
	/**
	 * Columns
	 */
	...
	private String cipheredUrl;
	private String CIPHERED_URL;
	private String url;
	private String URL;
	...
	public AsgDeliverablesAuthEmail() throws Exception {
		Class cls = getClass();
		...
		setFrwVarDateColumn("");
		setFrwVarNumberColumn("LINK_ID,APPROVER_ID,ASG_DELIVERABLES_RATES_ID");
		setFrwVarClobColumn("");
	...
	public String getCipheredUrl() {
		return cipheredUrl;
	}

	public void setCipheredUrl(String cipheredUrl) throws Exception {
		this.cipheredUrl = cipheredUrl;
		setValueFromAccessor("CIPHERED_URL", cipheredUrl);
	}
	...
	public String toXmlString() {
		...
		str += "<column name=\"cipheredUrl\" value=\""+cipheredUrl+"\">";
		str += "<column name=\"url\" value=\""+url+"\">";
