...
public class Wso2ApiOrganisationLink extends BaseDto implements Serializable {
	/**
	 * Columns
	 */
	...
	public Wso2ApiOrganisationLink() throws Exception {
		Class cls = getClass();
		...
		setFrwVarPrimaryKey("");
		setFrwVarDateColumn("");
		setFrwVarNumberColumn("LINK_ID,ORGANISATION_ID,WSO2_API_CONFIG_ID");
		setFrwVarClobColumn("");
