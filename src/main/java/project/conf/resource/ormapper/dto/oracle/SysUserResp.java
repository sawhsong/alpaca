...
public class SysUserResp extends BaseDto implements Serializable {
	/**
	 * Columns
	 */
	private double userRespId;
	private String USER_RESP_ID;
	...
	public SysUserResp() throws Exception {
		Class cls = getClass();
		...
		setFrwVarPrimaryKey("USER_RESP_ID");
		setFrwVarDateColumn("CREATION_DATE,LAST_UPDATE_DATE");
		setFrwVarNumberColumn("USER_RESP_ID,CREATED_BY,LAST_UPDATED_BY,RESPONSIBILITY_ID,USER_ID");
		setFrwVarClobColumn("");
	 ...
	 * Accessors
	 */
	public double getUserRespId() {
		return userRespId;
	}

	public void setUserRespId(double userRespId) throws Exception {
		this.userRespId = userRespId;
		setValueFromAccessor("USER_RESP_ID", CommonUtil.toString(userRespId));
	}
	...
	public String toXmlString() {
		...
		str += "<column name=\"userRespId\" value=\""+userRespId+"\">";
