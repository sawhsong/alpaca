...
public class WcSaUpdateRates20170307 extends BaseDto implements Serializable {
	/**
	 * Columns
	 */
	...
	public WcSaUpdateRates20170307() throws Exception {
		Class cls = getClass();
		...
		setFrwVarNumberColumn("CODE_RATE_D_ID,CODE_RATE_ID,NEW_PERCENTAGE,PERCENTAGE");
		setFrwVarClobColumn("");
