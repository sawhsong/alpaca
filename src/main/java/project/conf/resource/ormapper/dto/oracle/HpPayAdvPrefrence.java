...
public class HpPayAdvPrefrence extends BaseDto implements Serializable {
	/**
	 * Columns
	 */
	...
	public HpPayAdvPrefrence() throws Exception {
		Class cls = getClass();
		...
		setFrwVarDateColumn("");
		setFrwVarNumberColumn("PREFERENCE_ID,PERSON_ID");
		setFrwVarClobColumn("");
	...
	public void setEmailYn(String emailYn) throws Exception {
		this.emailYn = emailYn;
		setValueFromAccessor("EMAIL_YN", emailYn);
	}
	...
	public void setOnlineYn(String onlineYn) throws Exception {
		this.onlineYn = onlineYn;
		setValueFromAccessor("ONLINE_YN", onlineYn);
	}
	...
	public void setOtherYn(String otherYn) throws Exception {
		this.otherYn = otherYn;
		setValueFromAccessor("OTHER_YN", otherYn);
	}
	...
	public void setOthDesc(String othDesc) throws Exception {
		this.othDesc = othDesc;
		setValueFromAccessor("OTH_DESC", othDesc);
	}
	...
	public String toXmlString() {
		...
		str += "<column name=\"emailYn\" value=\""+emailYn+"\">";
		str += "<column name=\"onlineYn\" value=\""+onlineYn+"\">";
		str += "<column name=\"otherYn\" value=\""+otherYn+"\">";
		str += "<column name=\"othDesc\" value=\""+othDesc+"\">";
