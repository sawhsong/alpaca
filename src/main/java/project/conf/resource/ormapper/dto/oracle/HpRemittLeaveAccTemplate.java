...
public class HpRemittLeaveAccTemplate extends BaseDto implements Serializable {
	/**
	 * Columns
	 */
	...
	private double templateLeaveAccId;
	private String TEMPLATE_LEAVE_ACC_ID;
	...
	public HpRemittLeaveAccTemplate() throws Exception {
		Class cls = getClass();
		...
		setFrwVarNumberColumn("CREATED_BY,LAST_UPDATED_BY,PLAN_ID,REMITTANCE_ADVICE_TEMPLATE_ID,TEMPLATE_LEAVE_ACC_ID");
		setFrwVarClobColumn("");
	...
	public double getTemplateLeaveAccId() {
		return templateLeaveAccId;
	}

	public void setTemplateLeaveAccId(double templateLeaveAccId) throws Exception {
		this.templateLeaveAccId = templateLeaveAccId;
		setValueFromAccessor("TEMPLATE_LEAVE_ACC_ID", CommonUtil.toString(templateLeaveAccId));
	}
	...
	public String toString() {
		...
		str += "templateLeaveAccId : "+templateLeaveAccId+"\n";
	...
	public String toXmlString() {
		...
		str += "<column name=\"templateLeaveAccId\" value=\""+templateLeaveAccId+"\">";
