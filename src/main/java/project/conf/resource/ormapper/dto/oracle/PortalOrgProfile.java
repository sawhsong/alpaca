...
public class PortalOrgProfile extends BaseDto implements Serializable {
	/**
	 * Columns
	 */
	...
	public PortalOrgProfile() throws Exception {
		Class cls = getClass();
		...
		setFrwVarPrimaryKey("PORTAL_ORG_PROFILE_ID");
		setFrwVarDateColumn("CREATION_DATE,LAST_UPDATE_DATE");
		setFrwVarNumberColumn("PORTAL_ORG_PROFILE_ID,CREATED_BY,LAST_UPDATED_BY,ORG_ID");
		setFrwVarClobColumn("");
	...
	public void setProfileName(String profileName) throws Exception {
		this.profileName = profileName;
		setValueFromAccessor("PROFILE_NAME", profileName);
	}
	...
	public void setSendFromEmail(String sendFromEmail) throws Exception {
		this.sendFromEmail = sendFromEmail;
		setValueFromAccessor("SEND_FROM_EMAIL", sendFromEmail);
	}
	...
	public String toString() {
		...
		str += "sendFromEmail : "+sendFromEmail+"\n";
	...
	public String toXmlString() {
		...
		str += "<column name=\"profileName\" value=\""+profileName+"\">";
		str += "<column name=\"sendFromEmail\" value=\""+sendFromEmail+"\">";
