...
public class PortalSignupBankDetails extends BaseDto implements Serializable {
	/**
	 * Columns
	 */
	private double userTfId;
	private String USER_TF_ID;
	private double bankDetailsId;
	...
	public PortalSignupBankDetails() throws Exception {
		Class cls = getClass();
		...
		setFrwVarPrimaryKey("BANK_DETAILS_ID");
		setFrwVarDateColumn("CREATION_DATE,LAST_UPDATE_DATE");
		setFrwVarNumberColumn("USER_TF_ID,BANK_DETAILS_ID,CREATED_BY,LAST_UPDATED_BY,ASG_PAY_METHOD_ID,AMOUNT,PRIORITY");
		setFrwVarClobColumn("");
	...
	public double getBankDetailsId() {
		return bankDetailsId;
	}

	public void setBankDetailsId(double bankDetailsId) throws Exception {
		this.bankDetailsId = bankDetailsId;
		setValueFromAccessor("BANK_DETAILS_ID", CommonUtil.toString(bankDetailsId));
	}
	...
	public void setAccountNo(String accountNo) throws Exception {
		...
		setValueFromAccessor("ACCOUNT_NO", accountNo);
	}
	...
	public void setAmountUnit(String amountUnit) throws Exception {
		this.amountUnit = amountUnit;
		setValueFromAccessor("AMOUNT_UNIT", amountUnit);
	}
	...
	public String toString() {
		...
		str += "bankDetailsId : "+bankDetailsId+"\n";
	...
	public String toXmlString() {
		...
		str += "<column name=\"bankDetailsId\" value=\""+bankDetailsId+"\">";
		...
		str += "<column name=\"accountNo\" value=\""+accountNo+"\">";
		str += "<column name=\"amount\" value=\""+amount+"\">";
		str += "<column name=\"amountUnit\" value=\""+amountUnit+"\">";
