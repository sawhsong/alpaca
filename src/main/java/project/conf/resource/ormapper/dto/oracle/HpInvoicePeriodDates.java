...
public class HpInvoicePeriodDates extends BaseDto implements Serializable {
	/**
	 * Columns
	 */
	...
	public HpInvoicePeriodDates() throws Exception {
		Class cls = getClass();
		...
		setFrwVarDateColumn("END_DATE,START_DATE,INVOICE_DATE");
