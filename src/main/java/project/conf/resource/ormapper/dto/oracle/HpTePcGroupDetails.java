...
public class HpTePcGroupDetails extends BaseDto implements Serializable {
	/**
	 * Columns
	 */
	...
	public HpTePcGroupDetails() throws Exception {
		Class cls = getClass();
		...
		setFrwVarNumberColumn("DETAIL_ID,CREATED_BY,GROUP_ID,LAST_UPDATED_BY,PERSON_ID");
		setFrwVarClobColumn("");
