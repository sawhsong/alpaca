...
public class HpAsgSetDetails extends BaseDto implements Serializable {
	/**
	 * Columns
	 */
	...
	private double asgSetDetailId;
	private String ASG_SET_DETAIL_ID;
	...
	public HpAsgSetDetails() throws Exception {
		Class cls = getClass();
		...
		setFrwVarNumberColumn("ASSIGNMENT_ID,ASSIGNMENT_SET_ID,CREATED_BY,LAST_UPDATED_BY,ASG_SET_DETAIL_ID");
		setFrwVarClobColumn("");
	...
	public double getAsgSetDetailId() {
		return asgSetDetailId;
	}

	public void setAsgSetDetailId(double asgSetDetailId) throws Exception {
		this.asgSetDetailId = asgSetDetailId;
		setValueFromAccessor("ASG_SET_DETAIL_ID", CommonUtil.toString(asgSetDetailId));
	}
	...
	public String toString() {
		...
		str += "asgSetDetailId : "+asgSetDetailId+"\n";
	...
	public String toXmlString() {
		...
		str += "<column name=\"asgSetDetailId\" value=\""+asgSetDetailId+"\">";
