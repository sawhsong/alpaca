...
public class HpTimesheetPeriodDatesBk extends BaseDto implements Serializable {
	/**
	 * Columns
	 */
	...
	public HpTimesheetPeriodDatesBk() throws Exception {
		Class cls = getClass();
		...
		setFrwVarPrimaryKey("");
		setFrwVarDateColumn("END_DATE,START_DATE,TIMESHEET_DATE");
		setFrwVarNumberColumn("BILLING_CODE_ID,PERIOD_ID");
		setFrwVarClobColumn("");
	...
	public void setTimesheetDate(Date timesheetDate) throws Exception {
		this.timesheetDate = timesheetDate;
		setValueFromAccessor("TIMESHEET_DATE", CommonUtil.toString(timesheetDate));
	}
	...
	public String toString() {
		...
		str += "timesheetDate : "+timesheetDate+"\n";
	...
	public String toXmlString() {
		...
		str += "<column name=\"timesheetDate\" value=\""+timesheetDate+"\">";
