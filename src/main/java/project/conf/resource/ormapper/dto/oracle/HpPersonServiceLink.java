...
public class HpPersonServiceLink extends BaseDto implements Serializable {
	/**
	 * Columns
	 */
	...
	public HpPersonServiceLink() throws Exception {
		Class cls = getClass();
		...
		setFrwVarDateColumn("");
		setFrwVarNumberColumn("LINK_ID,PERSON_ID,PERSON_SERVICE_ID,WSO2_API_CONFIG_ID");
		setFrwVarClobColumn("");
