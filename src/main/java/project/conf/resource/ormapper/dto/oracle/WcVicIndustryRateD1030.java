...
public class WcVicIndustryRateD1030 extends BaseDto implements Serializable {
	/**
	 * Columns
	 */
	...
	private double industryRateDId;
	private String INDUSTRY_RATE_D_ID;
	...
	public WcVicIndustryRateD1030() throws Exception {
		Class cls = getClass();
		...
		setFrwVarNumberColumn("CREATED_BY,INDUSTRY_RATE_D_ID,INDUSTRY_RATE_ID,LAST_UPDATED_BY,PERCENTAGE");
		setFrwVarClobColumn("");
	...
	public double getIndustryRateDId() {
		return industryRateDId;
	}

	public void setIndustryRateDId(double industryRateDId) throws Exception {
		this.industryRateDId = industryRateDId;
		setValueFromAccessor("INDUSTRY_RATE_D_ID", CommonUtil.toString(industryRateDId));
	}
	...
	public String toString() {
		...
		str += "endDate : "+endDate+"\n";
		str += "industryRateDId : "+industryRateDId+"\n";
	...
	public String toXmlString() {
		...
		str += "<column name=\"industryRateDId\" value=\""+industryRateDId+"\">";
