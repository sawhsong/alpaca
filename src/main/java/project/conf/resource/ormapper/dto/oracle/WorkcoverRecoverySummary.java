...
public class WorkcoverRecoverySummary extends BaseDto implements Serializable {
	/**
	 * Columns
	 */
	...
	public WorkcoverRecoverySummary() throws Exception {
		Class cls = getClass();
		...
		setFrwVarNumberColumn("SUMMARY_ID,AMOUNT,CREATED_BY,INVOICES,LAST_UPDATED_BY");
		setFrwVarClobColumn("");
