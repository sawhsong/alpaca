...
public class PortalExpense extends BaseDto implements Serializable {
	/**
	 * Columns
	 */
	...
	public PortalExpense() throws Exception {
		Class cls = getClass();
		...
		setFrwVarNumberColumn("EXPENSE_ID,CREATED_BY,LAST_UPDATED_BY,PERSON_ID");
		setFrwVarClobColumn("");
