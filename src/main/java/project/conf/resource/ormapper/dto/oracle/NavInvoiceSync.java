...
public class NavInvoiceSync extends BaseDto implements Serializable {
	/**
	 * Columns
	 */
	...
	public NavInvoiceSync() throws Exception {
		Class cls = getClass();
		...
		setFrwVarNumberColumn("INVOICE_ID,SYNC_BY,SYNC_ID");
		setFrwVarClobColumn("");
	...
	public void setSyncType(String syncType) throws Exception {
		this.syncType = syncType;
		setValueFromAccessor("SYNC_TYPE", syncType);
	}
	...
	public String toXmlString() {
		...
		str += "<column name=\"syncType\" value=\""+syncType+"\">";
