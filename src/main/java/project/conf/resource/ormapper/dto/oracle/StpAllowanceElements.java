...
public class StpAllowanceElements extends BaseDto implements Serializable {
	/**
	 * Columns
	 */
	...
	public StpAllowanceElements() throws Exception {
		Class cls = getClass();
		...
		setFrwVarNumberColumn("BUSINESS_GROUP_ID,CREATED_BY,LAST_UPDATED_BY,STP_ALLOWANCE_ID");
		setFrwVarClobColumn("");
