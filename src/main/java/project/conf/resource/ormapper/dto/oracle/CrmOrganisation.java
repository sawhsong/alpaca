...
public class CrmOrganisation extends BaseDto implements Serializable {
	/**
	 * Columns
	 */
	...
	private double crmOrganisationId;
	private String CRM_ORGANISATION_ID;
	...
	public CrmOrganisation() throws Exception {
		Class cls = getClass();
		...
		setFrwVarNumberColumn("CREATED_BY,CRM_ORGANISATION_ID,LAST_UPDATED_BY,ORGANISATION_ID,BUSINESS_GROUP_ID");
		setFrwVarClobColumn("");
	...
	public double getCrmOrganisationId() {
		return crmOrganisationId;
	}

	public void setCrmOrganisationId(double crmOrganisationId) throws Exception {
		this.crmOrganisationId = crmOrganisationId;
		setValueFromAccessor("CRM_ORGANISATION_ID", CommonUtil.toString(crmOrganisationId));
	}
	...
	public String toString() {
		...
		str += "crmOrganisationId : "+crmOrganisationId+"\n";
	...
	public String toXmlString() {
		...
		str += "<column name=\"crmOrganisationId\" value=\""+crmOrganisationId+"\">";
