...
public class SysLookupTypes extends BaseDto implements Serializable {
	/**
	 * Columns
	 */
	...
	public SysLookupTypes() throws Exception {
		Class cls = getClass();
		...
		setFrwVarPrimaryKey("LOOKUP_TYPE");
		setFrwVarDateColumn("CREATION_DATE,LAST_UPDATE_DATE");
		setFrwVarNumberColumn("CREATED_BY,LAST_UPDATED_BY");
		setFrwVarClobColumn("");
