...
public class OpportunityNaLink extends BaseDto implements Serializable {
	/**
	 * Columns
	 */
	...
	public OpportunityNaLink() throws Exception {
		Class cls = getClass();
		...
		setFrwVarPrimaryKey("");
		setFrwVarDateColumn("");
		setFrwVarNumberColumn("LINK_ID,NEXT_ACTION_ID,OPPORTUNITY_ID");
		setFrwVarClobColumn("");
