...
public class HpComments extends BaseDto implements Serializable {
	/**
	 * Columns
	 */
	...
	public HpComments() throws Exception {
		Class cls = getClass();
		...
		setFrwVarPrimaryKey("COMMENT_ID");
		setFrwVarDateColumn("CREATION_DATE,LAST_UPDATE_DATE");
		setFrwVarNumberColumn("COMMENT_ID,CREATED_BY,LAST_UPDATED_BY,PERSON_ID");
		setFrwVarClobColumn("");
