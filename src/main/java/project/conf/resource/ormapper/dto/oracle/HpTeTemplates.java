...
public class HpTeTemplates extends BaseDto implements Serializable {
	/**
	 * Columns
	 */
	...
	public HpTeTemplates() throws Exception {
		Class cls = getClass();
		...
		setFrwVarPrimaryKey("TEMPLATE_ID");
		setFrwVarDateColumn("CREATION_DATE,LAST_UPDATE_DATE");
		setFrwVarNumberColumn("TEMPLATE_ID,CREATED_BY,LAST_UPDATED_BY,TIMECARD_ID,BUSINESS_GROUP_ID");
		setFrwVarClobColumn("");
