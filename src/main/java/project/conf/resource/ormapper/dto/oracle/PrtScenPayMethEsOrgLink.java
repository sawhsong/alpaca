...
public class PrtScenPayMethEsOrgLink extends BaseDto implements Serializable {
	/**
	 * Columns
	 */
	private double esOrganisationId;
	private String ES_ORGANISATION_ID;
	...
	public PrtScenPayMethEsOrgLink() throws Exception {
		Class cls = getClass();
		...
		setFrwVarPrimaryKey("");
		setFrwVarDateColumn("");
		setFrwVarNumberColumn("ES_ORGANISATION_ID,LINK_ID,PAY_METHOD_ID,PRT_COH_SCENARIO_ID");
		setFrwVarClobColumn("");
	 ...
	 * Accessors
	 */
	public double getEsOrganisationId() {
		return esOrganisationId;
	}

	public void setEsOrganisationId(double esOrganisationId) throws Exception {
		this.esOrganisationId = esOrganisationId;
		setValueFromAccessor("ES_ORGANISATION_ID", CommonUtil.toString(esOrganisationId));
	}
	...
	public String toString() {
		...
		str += "esOrganisationId : "+esOrganisationId+"\n";
		str += "linkId : "+linkId+"\n";
	...
	public String toXmlString() {
		...
		str += "<column name=\"esOrganisationId\" value=\""+esOrganisationId+"\">";
