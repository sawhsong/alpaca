...
public class PortalOrganisationStage extends BaseDto implements Serializable {
	/**
	 * Columns
	 */
	...
	public PortalOrganisationStage() throws Exception {
		Class cls = getClass();
		...
		setFrwVarNumberColumn("SUBMISSION_ID,BUSINESS_GROUP_ID,CREATED_BY,LAST_UPDATED_BY,DIVISION_ID,MAIN_CONTACT,ORGANISATION_ID");
		setFrwVarClobColumn("");
