...
public class HpAsgResultDetails extends BaseDto implements Serializable {
	/**
	 * Columns
	 */
	...
	public HpAsgResultDetails() throws Exception {
		Class cls = getClass();
		...
		setFrwVarPrimaryKey("");
		setFrwVarDateColumn("");
		setFrwVarNumberColumn("ELEMENT_ATT_ID,RESULT_ID");
		setFrwVarClobColumn("");
	...
	public void setResultValue(String resultValue) throws Exception {
		...
		setValueFromAccessor("RESULT_VALUE", resultValue);
	}
	...
	public String toXmlString() {
		...
		str += "<column name=\"resultValue\" value=\""+resultValue+"\">";
