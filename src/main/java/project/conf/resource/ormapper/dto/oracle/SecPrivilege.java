...
public class SecPrivilege extends BaseDto implements Serializable {
	/**
	 * Columns
	 */
	...
	public SecPrivilege() throws Exception {
		Class cls = getClass();
		...
		setFrwVarPrimaryKey("PRIVILEGE_ID");
		setFrwVarDateColumn("CREATION_DATE,START_DATE,END_DATE,UPDATED_DATE");
		setFrwVarNumberColumn("PRIVILEGE_ID,CREATED_BY,PRIORITY,UPDATED_BY");
		setFrwVarClobColumn("");
