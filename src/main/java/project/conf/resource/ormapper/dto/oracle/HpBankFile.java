...
public class HpBankFile extends BaseDto implements Serializable {
	/**
	 * Columns
	 */
	...
	public HpBankFile() throws Exception {
		Class cls = getClass();
		...
		setFrwVarPrimaryKey("BANK_FILE_ID");
		setFrwVarDateColumn("CREATION_DATE,LAST_UPDATE_DATE");
		setFrwVarNumberColumn("BANK_FILE_ID,CREATED_BY,LAST_UPDATED_BY,BUSINESS_GROUP_ID");
		setFrwVarClobColumn("BANK_FILE,LOG_FILE");
	...
	public void setBankFile(String bankFile) throws Exception {
		this.bankFile = bankFile;
		setValueFromAccessor("BANK_FILE", bankFile);
	}
	...
	public void setBankFileName(String bankFileName) throws Exception {
		this.bankFileName = bankFileName;
		setValueFromAccessor("BANK_FILE_NAME", bankFileName);
	}
	...
	public String toString() {
		...
		str += "bankFile : "+bankFile+"\n";
		str += "bankFileName : "+bankFileName+"\n";
	...
	public String toXmlString() {
		...
		str += "<column name=\"bankFile\" value=\""+bankFile+"\">";
		str += "<column name=\"bankFileName\" value=\""+bankFileName+"\">";
