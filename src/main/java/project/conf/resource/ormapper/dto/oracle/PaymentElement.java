...
public class PaymentElement extends BaseDto implements Serializable {
	/**
	 * Columns
	 */
	...
	public PaymentElement() throws Exception {
		Class cls = getClass();
		...
		setFrwVarPrimaryKey("PAYMENT_ELEMENT_ID");
		setFrwVarDateColumn("CREATION_DATE,LAST_UPDATE_DATE");
		setFrwVarNumberColumn("PAYMENT_ID,PAYMENT_ELEMENT_ID,CREATED_BY,ELEMENT_ID,LAST_UPDATED_BY,SEQUENCE,CALCULATED_AMOUNT,INPUT_AMOUNT,SOURCE_ID");
		setFrwVarClobColumn("");
	...
	public void setSequence(double sequence) throws Exception {
		this.sequence = sequence;
		setValueFromAccessor("SEQUENCE", CommonUtil.toString(sequence));
	}
	...
	public void setCalculatedAmount(double calculatedAmount) throws Exception {
		this.calculatedAmount = calculatedAmount;
		setValueFromAccessor("CALCULATED_AMOUNT", CommonUtil.toString(calculatedAmount));
	}
	...
	public void setInputAmount(double inputAmount) throws Exception {
		this.inputAmount = inputAmount;
		setValueFromAccessor("INPUT_AMOUNT", CommonUtil.toString(inputAmount));
	}
	...
	public String toString() {
		...
		str += "calculatedAmount : "+calculatedAmount+"\n";
		str += "inputAmount : "+inputAmount+"\n";
		str += "period : "+period+"\n";
		str += "source : "+source+"\n";
	...
	public String toXmlString() {
		...
		str += "<column name=\"sequence\" value=\""+sequence+"\">";
		str += "<column name=\"calculatedAmount\" value=\""+calculatedAmount+"\">";
		str += "<column name=\"inputAmount\" value=\""+inputAmount+"\">";
