...
public class PortalUserTfStep extends BaseDto implements Serializable {
	/**
	 * Columns
	 */
	...
	public PortalUserTfStep() throws Exception {
		Class cls = getClass();
		...
		setFrwVarPrimaryKey("USER_TF_STEP_ID");
		setFrwVarDateColumn("CREATION_DATE,LAST_UPDATE_DATE");
		setFrwVarNumberColumn("USER_TF_STEP_ID,STEP_ID,USER_TF_ID,CREATED_BY,LAST_UPDATED_BY");
		setFrwVarClobColumn("");
		setFrwVarDefaultColumn("IS_COMPLETED");
