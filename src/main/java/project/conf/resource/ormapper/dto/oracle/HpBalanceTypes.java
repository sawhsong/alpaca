...
public class HpBalanceTypes extends BaseDto implements Serializable {
	/**
	 * Columns
	 */
	...
	public HpBalanceTypes() throws Exception {
		Class cls = getClass();
		...
		setFrwVarPrimaryKey("BALANCE_ID");
		setFrwVarDateColumn("CREATION_DATE,LAST_UPDATE_DATE");
		setFrwVarNumberColumn("BALANCE_ID,BUSINESS_GROUP_ID,CREATED_BY,LAST_UPDATED_BY");
		setFrwVarClobColumn("");
	...
	public void setBalanceName(String balanceName) throws Exception {
		this.balanceName = balanceName;
		setValueFromAccessor("BALANCE_NAME", balanceName);
	}
