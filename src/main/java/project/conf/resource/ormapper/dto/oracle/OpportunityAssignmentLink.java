...
public class OpportunityAssignmentLink extends BaseDto implements Serializable {
	/**
	 * Columns
	 */
	...
	public OpportunityAssignmentLink() throws Exception {
		Class cls = getClass();
		...
		setFrwVarPrimaryKey("");
		setFrwVarDateColumn("");
		setFrwVarNumberColumn("ASSIGNMENT_ID,LINK_ID,OPPORTUNITY_ID");
		setFrwVarClobColumn("");
	...
	public void setCreationType(String creationType) throws Exception {
		this.creationType = creationType;
		setValueFromAccessor("CREATION_TYPE", creationType);
	}
	...
	public String toXmlString() {
		...
		str += "<column name=\"creationType\" value=\""+creationType+"\">";
