...
public class TfndPayeeRecordDocLink extends BaseDto implements Serializable {
	/**
	 * Columns
	 */
	...
	public TfndPayeeRecordDocLink() throws Exception {
		Class cls = getClass();
		...
		setFrwVarDateColumn("");
		setFrwVarNumberColumn("LINK_ID,DOCUMENT_ID,TFND_REPORT_PAYEE_RECORD_ID");
		setFrwVarClobColumn("");
