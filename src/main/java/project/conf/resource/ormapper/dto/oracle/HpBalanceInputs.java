...
public class HpBalanceInputs extends BaseDto implements Serializable {
	/**
	 * Columns
	 */
	private double balanceInpId;
	private String BALANCE_INP_ID;
	...
	public HpBalanceInputs() throws Exception {
		Class cls = getClass();
		...
		setFrwVarPrimaryKey("BALANCE_INP_ID");
		setFrwVarDateColumn("CREATION_DATE,LAST_UPDATE_DATE");
		setFrwVarNumberColumn("BALANCE_INP_ID,BUSINESS_GROUP_ID,CREATED_BY,LAST_UPDATED_BY,ADD_SUBTRACT,BALANCE_ID,ELEMENT_ATT_ID");
		setFrwVarClobColumn("");
	 ...
	 * Accessors
	 */
	public double getBalanceInpId() {
		return balanceInpId;
	}

	public void setBalanceInpId(double balanceInpId) throws Exception {
		this.balanceInpId = balanceInpId;
		setValueFromAccessor("BALANCE_INP_ID", CommonUtil.toString(balanceInpId));
	}
	...
	public double getAddSubtract() {
		return addSubtract;
	}

	public void setAddSubtract(double addSubtract) throws Exception {
		this.addSubtract = addSubtract;
		setValueFromAccessor("ADD_SUBTRACT", CommonUtil.toString(addSubtract));
	}
	...
	public String toString() {
		...
		str += "balanceInpId : "+balanceInpId+"\n";
		str += "businessGroupId : "+businessGroupId+"\n";
		str += "createdBy : "+createdBy+"\n";
		str += "creationDate : "+creationDate+"\n";
		str += "lastUpdatedBy : "+lastUpdatedBy+"\n";
		str += "lastUpdateDate : "+lastUpdateDate+"\n";
		str += "addSubtract : "+addSubtract+"\n";
	...
	public String toXmlString() {
		...
		str += "<column name=\"balanceInpId\" value=\""+balanceInpId+"\">";
		str += "<column name=\"businessGroupId\" value=\""+businessGroupId+"\">";
		str += "<column name=\"createdBy\" value=\""+createdBy+"\">";
		str += "<column name=\"creationDate\" value=\""+creationDate+"\">";
		str += "<column name=\"lastUpdatedBy\" value=\""+lastUpdatedBy+"\">";
		str += "<column name=\"lastUpdateDate\" value=\""+lastUpdateDate+"\">";
		str += "<column name=\"addSubtract\" value=\""+addSubtract+"\">";
