...
public class NavResourceSync extends BaseDto implements Serializable {
	/**
	 * Columns
	 */
	...
	public NavResourceSync() throws Exception {
		Class cls = getClass();
		...
		setFrwVarNumberColumn("PERSON_NUMBER,SYNC_ID");
		setFrwVarClobColumn("");
