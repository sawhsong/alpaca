...
public class ScheduledPayrollNotes extends BaseDto implements Serializable {
	/**
	 * Columns
	 */
	...
	public ScheduledPayrollNotes() throws Exception {
		Class cls = getClass();
		...
		setFrwVarNumberColumn("CREATED_BY,LAST_UPDATED_BY,NOTIFICATION_ID,PERSON_ID");
		setFrwVarClobColumn("");
	...
	public void setNotificationPeriod(String notificationPeriod) throws Exception {
		this.notificationPeriod = notificationPeriod;
		setValueFromAccessor("NOTIFICATION_PERIOD", notificationPeriod);
	}
	...
	public void setNotificationText(String notificationText) throws Exception {
		this.notificationText = notificationText;
		setValueFromAccessor("NOTIFICATION_TEXT", notificationText);
	}
	...
	public void setNotificationType(String notificationType) throws Exception {
		...
		setValueFromAccessor("NOTIFICATION_TYPE", notificationType);
	}
	...
	public String toString() {
		...
		str += "notificationPeriod : "+notificationPeriod+"\n";
		str += "notificationText : "+notificationText+"\n";
	...
	public String toXmlString() {
		...
		str += "<column name=\"notificationPeriod\" value=\""+notificationPeriod+"\">";
		str += "<column name=\"notificationText\" value=\""+notificationText+"\">";
		str += "<column name=\"notificationType\" value=\""+notificationType+"\">";
