...
public class EoExpenseAuthEmailLink extends BaseDto implements Serializable {
	/**
	 * Columns
	 */
	...
	public EoExpenseAuthEmailLink() throws Exception {
		Class cls = getClass();
		...
		setFrwVarDateColumn("");
		setFrwVarNumberColumn("LINK_ID,APPROVER_ID,EO_EXPENSE_ID");
		setFrwVarClobColumn("");
