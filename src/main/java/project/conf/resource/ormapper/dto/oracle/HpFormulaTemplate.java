...
public class HpFormulaTemplate extends BaseDto implements Serializable {
	/**
	 * Columns
	 */
	...
	public HpFormulaTemplate() throws Exception {
		Class cls = getClass();
		...
		setFrwVarPrimaryKey("");
		setFrwVarDateColumn("");
		setFrwVarNumberColumn("ASSIGNMENT_ID,BUSINESS_GROUP_ID,FORMULA_ID");
		setFrwVarClobColumn("");
	...
	public void setFormulaId(double formulaId) throws Exception {
		this.formulaId = formulaId;
		setValueFromAccessor("FORMULA_ID", CommonUtil.toString(formulaId));
	}
	...
	public void setTemplate(String template) throws Exception {
		...
		setValueFromAccessor("TEMPLATE", template);
	}
	...
	public String toXmlString() {
		...
		str += "<column name=\"formulaId\" value=\""+formulaId+"\">";
		str += "<column name=\"template\" value=\""+template+"\">";
