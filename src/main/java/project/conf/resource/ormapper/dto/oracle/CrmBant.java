...
public class CrmBant extends BaseDto implements Serializable {
	/**
	 * Columns
	 */
	private double bantId;
	private String BANT_ID;
	...
	public CrmBant() throws Exception {
		Class cls = getClass();
		...
		setFrwVarPrimaryKey("BANT_ID");
		setFrwVarDateColumn("CREATION_DATE,LAST_UPDATE_DATE");
		setFrwVarNumberColumn("BANT_ID,CREATED_BY,LAST_UPDATED_BY,ORGANISATION_ID,BUSINESS_GROUP_ID");
		setFrwVarClobColumn("");
	 ...
	 * Accessors
	 */
	public double getBantId() {
		return bantId;
	}

	public void setBantId(double bantId) throws Exception {
		this.bantId = bantId;
		setValueFromAccessor("BANT_ID", CommonUtil.toString(bantId));
	}
	...
	public void setAuthority(String authority) throws Exception {
		...
		setValueFromAccessor("AUTHORITY", authority);
	}
	...
	public void setBudget(String budget) throws Exception {
		this.budget = budget;
		setValueFromAccessor("BUDGET", budget);
	}
	...
	public void setNeed(String need) throws Exception {
		this.need = need;
		setValueFromAccessor("NEED", need);
	}
	...
	public void setTimeframe(String timeframe) throws Exception {
		...
		setValueFromAccessor("TIMEFRAME", timeframe);
	}
	...
	public String toXmlString() {
		...
		str += "<column name=\"bantId\" value=\""+bantId+"\">";
		str += "<column name=\"createdBy\" value=\""+createdBy+"\">";
		str += "<column name=\"creationDate\" value=\""+creationDate+"\">";
		str += "<column name=\"lastUpdatedBy\" value=\""+lastUpdatedBy+"\">";
		str += "<column name=\"lastUpdateDate\" value=\""+lastUpdateDate+"\">";
		str += "<column name=\"organisationId\" value=\""+organisationId+"\">";
		str += "<column name=\"authority\" value=\""+authority+"\">";
		str += "<column name=\"budget\" value=\""+budget+"\">";
		str += "<column name=\"businessGroupId\" value=\""+businessGroupId+"\">";
		str += "<column name=\"need\" value=\""+need+"\">";
		str += "<column name=\"timeframe\" value=\""+timeframe+"\">";
