...
public class IproBatchUploadHeader extends BaseDto implements Serializable {
	/**
	 * Columns
	 */
	...
	private double numberOfIpro;
	private String NUMBER_OF_IPRO;
	...
	public IproBatchUploadHeader() throws Exception {
		Class cls = getClass();
		...
		setFrwVarPrimaryKey("HEADER_ID");
		setFrwVarDateColumn("CREATION_DATE,LAST_UPDATED_DATE");
		setFrwVarNumberColumn("HEADER_ID,CREATED_BY,LAST_UPDATED_BY,NUMBER_OF_IPRO");
		setFrwVarClobColumn("");
	...
	public double getNumberOfIpro() {
		return numberOfIpro;
	}

	public void setNumberOfIpro(double numberOfIpro) throws Exception {
		this.numberOfIpro = numberOfIpro;
		setValueFromAccessor("NUMBER_OF_IPRO", CommonUtil.toString(numberOfIpro));
	}
	...
	public void setOriginalData(String originalData) throws Exception {
		this.originalData = originalData;
		setValueFromAccessor("ORIGINAL_DATA", originalData);
	}
	...
	public void setOriginalFileName(String originalFileName) throws Exception {
		this.originalFileName = originalFileName;
		setValueFromAccessor("ORIGINAL_FILE_NAME", originalFileName);
	}
	...
	public String toString() {
		...
		str += "numberOfIpro : "+numberOfIpro+"\n";
		str += "comments : "+comments+"\n";
		str += "customerName : "+customerName+"\n";
		str += "originalData : "+originalData+"\n";
	...
	public String toXmlString() {
		...
		str += "<column name=\"numberOfIpro\" value=\""+numberOfIpro+"\">";
		str += "<column name=\"comments\" value=\""+comments+"\">";
		str += "<column name=\"customerName\" value=\""+customerName+"\">";
		str += "<column name=\"originalData\" value=\""+originalData+"\">";
		str += "<column name=\"originalFileName\" value=\""+originalFileName+"\">";
