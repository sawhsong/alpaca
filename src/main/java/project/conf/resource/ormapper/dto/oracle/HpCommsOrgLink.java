...
public class HpCommsOrgLink extends BaseDto implements Serializable {
	/**
	 * Columns
	 */
	...
	public HpCommsOrgLink() throws Exception {
		Class cls = getClass();
		...
		setFrwVarNumberColumn("CONTACT_ID,CREATED_BY,LAST_UPDATED_BY,LINK_ID,ORGANISATION_ID");
		setFrwVarClobColumn("");
