...
public class NavCustomerSync extends BaseDto implements Serializable {
	/**
	 * Columns
	 */
	...
	public NavCustomerSync() throws Exception {
		Class cls = getClass();
		...
		setFrwVarNumberColumn("ORGANISATION_ID,SYNC_ID");
		setFrwVarClobColumn("");
