...
public class OpportunityDocsLink extends BaseDto implements Serializable {
	/**
	 * Columns
	 */
	...
	public OpportunityDocsLink() throws Exception {
		Class cls = getClass();
		...
		setFrwVarPrimaryKey("");
		setFrwVarDateColumn("");
		setFrwVarNumberColumn("DOCUMENT_ID,LINK_ID,OPPORTUNITY_ID");
		setFrwVarClobColumn("");
