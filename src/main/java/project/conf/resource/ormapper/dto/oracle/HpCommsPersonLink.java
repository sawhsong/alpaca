...
public class HpCommsPersonLink extends BaseDto implements Serializable {
	/**
	 * Columns
	 */
	...
	public HpCommsPersonLink() throws Exception {
		Class cls = getClass();
		...
		setFrwVarNumberColumn("CONTACT_ID,CREATED_BY,LAST_UPDATED_BY,LINK_ID,PERSON_ID");
		setFrwVarClobColumn("");
