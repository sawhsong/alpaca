...
public class MasterDocumentList extends BaseDto implements Serializable {
	/**
	 * Columns
	 */
	...
	private String MASTER_DOCUMENT_NAME;
	...
	public MasterDocumentList() throws Exception {
		Class cls = getClass();
		...
		setFrwVarNumberColumn("CREATED_BY,LAST_UPDATED_BY,MASTER_DOCUMENT_ID");
		setFrwVarClobColumn("");
	...
	public void setMasterDocumentName(String masterDocumentName) throws Exception {
		this.masterDocumentName = masterDocumentName;
		setValueFromAccessor("MASTER_DOCUMENT_NAME", masterDocumentName);
	}
	...
	public String toString() {
		...
		str += "masterDocumentName : "+masterDocumentName+"\n";
	...
	public String toXmlString() {
		...
		str += "<column name=\"masterDocumentName\" value=\""+masterDocumentName+"\">";
