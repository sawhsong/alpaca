...
public class PortalAddressContactStage extends BaseDto implements Serializable {
	/**
	 * Columns
	 */
	...
	public PortalAddressContactStage() throws Exception {
		Class cls = getClass();
		...
		setFrwVarNumberColumn("SUBMISSION_ID,ADDRESS_ID,BUSINESS_GROUP_ID,CREATED_BY,LAST_UPDATED_BY,PERSON_ID");
		setFrwVarClobColumn("");
