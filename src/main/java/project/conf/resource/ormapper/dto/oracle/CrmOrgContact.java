...
public class CrmOrgContact extends BaseDto implements Serializable {
	/**
	 * Columns
	 */
	...
	private double crmOrgContactId;
	private String CRM_ORG_CONTACT_ID;
	...
	public CrmOrgContact() throws Exception {
		Class cls = getClass();
		...
		setFrwVarNumberColumn("CREATED_BY,CRM_ORG_CONTACT_ID,LAST_UPDATED_BY,ORGANISATION_ID,BUSINESS_GROUP_ID");
		setFrwVarClobColumn("");
	...
	public double getCrmOrgContactId() {
		return crmOrgContactId;
	}

	public void setCrmOrgContactId(double crmOrgContactId) throws Exception {
		this.crmOrgContactId = crmOrgContactId;
		setValueFromAccessor("CRM_ORG_CONTACT_ID", CommonUtil.toString(crmOrgContactId));
	}
	...
	public String toString() {
		...
		str += "crmOrgContactId : "+crmOrgContactId+"\n";
	...
	public String toXmlString() {
		...
		str += "<column name=\"crmOrgContactId\" value=\""+crmOrgContactId+"\">";
