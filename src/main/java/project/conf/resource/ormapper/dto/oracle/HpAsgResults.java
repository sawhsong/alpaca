...
public class HpAsgResults extends BaseDto implements Serializable {
	/**
	 * Columns
	 */
	...
	public HpAsgResults() throws Exception {
		Class cls = getClass();
		...
		setFrwVarPrimaryKey("RESULT_ID");
		setFrwVarDateColumn("CREATION_DATE,LAST_UPDATE_DATE");
		setFrwVarNumberColumn("RESULT_ID,CREATED_BY,LAST_UPDATED_BY,ASSIGNMENT_PROCESS_ID,ELEMENT_ID,SOURCE_ID");
		setFrwVarClobColumn("");
	...
	public void setEntryType(String entryType) throws Exception {
		this.entryType = entryType;
		setValueFromAccessor("ENTRY_TYPE", entryType);
	}
	...
	public String toXmlString() {
		...
		str += "<column name=\"entryType\" value=\""+entryType+"\">";
