 ...
 *************************************************************************************************/
package project.app.sys.sysBbs.sysFreeBoard;
...
public class SysFreeBoardAction extends BaseAction {
	@Autowired
	private SysFreeBoardBiz biz;
	...
	public String exeInsert() throws Exception {
		try {
			...
			if (paramEntity.isSuccess()) {
				paramEntity.setObject("action", "/sys/sysBbs/sysFreeBoard/getDefault.do");
			} else {
