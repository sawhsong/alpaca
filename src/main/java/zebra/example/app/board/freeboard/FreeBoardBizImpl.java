...
public class FreeBoardBizImpl extends BaseBiz implements FreeBoardBiz {
	@Autowired
	...
	public ParamEntity getDetail(ParamEntity paramEntity) throws Exception {
		...
		try {
			paramEntity.setObject("freeBoard", zebraBoardDao.getBoardByArticleId(articleId));
	...
	public ParamEntity exeExport(ParamEntity paramEntity) throws Exception {
		...
		try {
			...
			exportHelper.setSourceDataSet(zebraBoardDao.getFreeBoardDataSetByCriteria(queryAdvisor));
