...
<div id="divDataArea" class="areaContainerFramePayslipPreview">
	...
	<div class="payslipPreviewSection">
		<table class="tblDefault withPadding">
			...
			<tr>
				<td class="tdDefault"><%=payslipMaster.getValue("EMP_ORG_NAME")%></td>
				<th class="thDefault Rt">Date</th>
				<td class="tdDefault"><%=payslipMaster.getValue("PAYMENT_DATE_FORMAT")%></td>
			</tr>
			<tr>
				<td class="tdDefault"><%=payslipMaster.getValue("EMP_ORG_ADDR")%></td>
	...
	<div id="divICRemittanceValues">
		<div class="verGap2"></div>
		<table id="tblICRemittanceValues" class="tblDefault withPadding">
			<colgroup>
				<col width="*"></col>
				<col width="14%"></col>
			</colgroup>
