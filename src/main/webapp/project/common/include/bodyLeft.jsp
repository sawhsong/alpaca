...
$(function() {
	...
	setLeftMenuAccordionHeight = function() {
		$("#divBodyLeftMenuPanel").height($("#divBodyLeft").outerHeight());
		$("#leftMenuAccordionHolder").height($("#divBodyLeft").outerHeight() - $("#divLeftMenuHeader").outerHeight());
...
%>
	<div id="leftMenuAccordionHolder" class="leftMenuAccordionHolder">
<%
