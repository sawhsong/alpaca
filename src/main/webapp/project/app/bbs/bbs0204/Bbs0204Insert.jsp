...
<div id="divDataArea" class="areaContainer">
	<table class="tblEdit">
		...
		<tr>
			...
			<td class="tdEdit">
				<ui:text name="writerName" value="<%=sysUser.getUserName()%>" checkName="bbs0204.header.writerName" options="mandatory"/>
			</td>
			<th class="thEdit Rt mandatory"><mc:msg key="bbs0204.header.writerEmail"/></th>
			<td class="tdEdit">
				<ui:text name="writerEmail" value="<%=sysUser.getEmail()%>" checkName="bbs0204.header.writerEmail" option="email" options="mandatory"/>
			</td>
		</tr>
		<tr>
			<th class="thEdit Rt mandatory"><mc:msg key="bbs0204.header.articleSubject"/></th>
			<td class="tdEdit" colspan="3">
				<ui:text name="articleSubject" checkName="bbs0204.header.articleSubject" options="mandatory"/>
			</td>
		</tr>
		<tr>
