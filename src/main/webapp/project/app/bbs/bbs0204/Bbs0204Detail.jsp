...
<div id="divDataArea" class="areaContainer">
	<table class="tblEdit">
		...
		<tr>
			<th class="thEdit Rt"><mc:msg key="bbs0204.header.writerName"/></th>
			<td class="tdEdit"><%=sysBoard.getWriterName()%>(<%=sysBoard.getWriterId()%>)</td>
			<th class="thEdit Rt"><mc:msg key="bbs0204.header.writerEmail"/></th>
		...
		<tr>
			<th class="thEdit Rt"><mc:msg key="bbs0204.header.articleSubject"/></th>
			<td class="tdEdit" colspan="3"><%=sysBoard.getArticleSubject()%></td>
		</tr>
		<tr>
			<th class="thEdit Rt"><mc:msg key="bbs0204.header.attachedFile"/></th>
