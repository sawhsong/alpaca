<%/************************************************************************************************
* Description - Pay1204 - Send Payslip
	...
	<div class="panel panel-default">
		<div class="panel-body">
			<table class="tblDefault">
				...
				<tr>
					<td class="tdDefault">
						<label for="searchType" class="lblEn hor"><mc:msg key="pay1204.search.searchType"/></label>
					...
					<td class="tdDefault">
						<label for="fromDate" class="lblEn hor"><mc:msg key="pay1204.search.searchPeriod"/></label>
						<ui:text id="fromDate" name="fromDate" className="defClass Ct hor" style="width:100px" checkName="pay1204.search.searchDateFrom" option="date"/>
						<ui:icon id="icnFromDate" className="fa-calendar icnEn hor" title="pay1204.search.searchDateFrom"/>
						<div class="horGap20" style="padding:6px 8px 6px 0px;">-</div>
						<ui:text id="toDate" name="toDate" className="defClass Ct hor" style="width:100px" checkName="pay1204.search.searchDateTo" option="date"/>
						<ui:icon id="icnToDate" className="fa-calendar icnEn hor" title="pay1204.search.searchDateTo"/>
					</td>
				</tr>
			</table>
		</div>
	...
	<table id="tblGrid" class="tblGrid sort autosort">
		...
		<thead>
			<tr class="noBorderHor">
				...
				<th class="thGrid sortable:alphanumeric"><mc:msg key="pay1204.grid.subject"/></th>
				<th class="thGrid"><mc:msg key="pay1204.grid.file"/></th>
				<th class="thGrid sortable:alphanumeric"><mc:msg key="pay1204.grid.writerName"/></th>
				<th class="thGrid sortable:date"><mc:msg key="pay1204.grid.date"/></th>
				<th class="thGrid sortable:numeric"><mc:msg key="pay1204.grid.hitCount"/></th>
