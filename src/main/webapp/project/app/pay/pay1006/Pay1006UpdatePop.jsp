...
<div id="divDataArea" class="areaContainerPopup">
	<table class="tblEdit">
		...
		<tr>
			<th class="thEdit Rt mandatory"><mc:msg key="pay1006.header.writerName"/></th>
			<td class="tdEdit">
				<ui:text id="writerName" name="writerName" className="defClass" value="<%=sysBoard.getWriterName()%>" checkName="pay1006.header.writerName" options="mandatory"/>
			</td>
			<th class="thEdit Rt mandatory"><mc:msg key="pay1006.header.writerEmail"/></th>
			<td class="tdEdit">
				<ui:text id="writerEmail" name="writerEmail" className="defClass" value="<%=sysBoard.getWriterEmail()%>" checkName="pay1006.header.writerEmail" option="email" options="mandatory"/>
			</td>
		</tr>
		<tr>
			<th class="thEdit Rt mandatory"><mc:msg key="pay1006.header.articleSubject"/></th>
			<td class="tdEdit" colspan="3">
				<ui:text id="articleSubject" name="articleSubject" className="defClass" value="<%=sysBoard.getArticleSubject()%>" checkName="pay1006.header.articleSubject" options="mandatory"/>
			</td>
		</tr>
		<tr>
			<th class="thEdit Rt"><mc:msg key="pay1006.header.articleContents"/></th>
			<td class="tdEdit" colspan="3">
		...
		<tr>
			<th class="thEdit Rt">
				<mc:msg key="pay1006.header.attachedFile"/><br/>
			</th>
			<td class="tdEdit" colspan="3">
