...
<div id="divDataArea" class="areaContainerPopup">
	<table class="tblEdit">
		...
		<tr>
			<th class="thEdit Rt mandatory"><mc:msg key="org0402.header.writerName"/></th>
			<td class="tdEdit">
				<ui:text id="writerName" name="writerName" className="defClass" value="<%=sysBoard.getWriterName()%>" checkName="org0402.header.writerName" options="mandatory"/>
			</td>
			<th class="thEdit Rt mandatory"><mc:msg key="org0402.header.writerEmail"/></th>
			<td class="tdEdit">
				<ui:text id="writerEmail" name="writerEmail" className="defClass" value="<%=sysBoard.getWriterEmail()%>" checkName="org0402.header.writerEmail" option="email" options="mandatory"/>
			</td>
		</tr>
		<tr>
			<th class="thEdit Rt mandatory"><mc:msg key="org0402.header.articleSubject"/></th>
			<td class="tdEdit" colspan="3">
				<ui:text id="articleSubject" name="articleSubject" className="defClass" value="<%=sysBoard.getArticleSubject()%>" checkName="org0402.header.articleSubject" options="mandatory"/>
			</td>
		</tr>
		<tr>
			<th class="thEdit Rt"><mc:msg key="org0402.header.articleContents"/></th>
			<td class="tdEdit" colspan="3">
		...
		<tr>
			<th class="thEdit Rt">
				<mc:msg key="org0402.header.attachedFile"/><br/>
			</th>
			<td class="tdEdit" colspan="3">
