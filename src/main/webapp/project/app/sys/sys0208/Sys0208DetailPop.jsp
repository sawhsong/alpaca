...
<div id="divDataArea" class="areaContainerPopup">
	<table class="tblEdit">
		...
		<tr>
			<th class="thEdit Rt"><mc:msg key="sys0208.header.writerName"/></th>
			<td class="tdEdit"><%=sysBoard.getWriterName()%>(<%=sysBoard.getWriterId()%>)</td>
			<th class="thEdit Rt"><mc:msg key="sys0208.header.writerEmail"/></th>
		...
		<tr>
			...
			<th class="thEdit Rt"><mc:msg key="sys0208.header.hitCount"/></th>
			<td class="tdEdit"><%=CommonUtil.getNumberMask(sysBoard.getHitCnt())%></td>
		</tr>
		<tr>
			<th class="thEdit Rt"><mc:msg key="sys0208.header.articleSubject"/></th>
		...
		<tr>
			<th class="thEdit Rt"><mc:msg key="sys0208.header.attachedFile"/></th>
