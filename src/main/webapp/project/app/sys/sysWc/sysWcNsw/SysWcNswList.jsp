...
<div id="divSearchCriteriaArea" class="areaContainer">
	<table class="tblSearch">
		...
		<tr>
			<th class="thSearch rt"><mc:msg key="sysWcNsw.search.searchType"/></th>
	...
	<table id="tblGrid" class="tblGrid sort autosort">
		...
		<thead>
			<tr>
				...
				<th class="thGrid sortable:alphanumeric"><mc:msg key="sysWcNsw.grid.subject"/></th>
				<th class="thGrid"><mc:msg key="sysWcNsw.grid.file"/></th>
				<th class="thGrid sortable:alphanumeric"><mc:msg key="sysWcNsw.grid.writerName"/></th>
				<th class="thGrid sortable:date"><mc:msg key="sysWcNsw.grid.date"/></th>
				<th class="thGrid sortable:numeric"><mc:msg key="sysWcNsw.grid.hitCount"/></th>
			</tr>
		</thead>
