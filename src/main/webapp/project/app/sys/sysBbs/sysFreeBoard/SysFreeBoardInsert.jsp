...
<div id="divDataArea" class="areaContainer">
	<table class="tblEdit">
		...
		<tr>
			...
			<td class="tdEdit">
				<ui:text name="writerName" value="<%=sysUser.getUserName()%>" checkName="Writer" options="mandatory"/>
			</td>
			<th class="thEdit Rt mandatory">Email</th>
			<td class="tdEdit">
				<ui:text name="writerEmail" value="<%=sysUser.getEmail()%>" checkName="Email" option="email" options="mandatory"/>
			</td>
		</tr>
		<tr>
			<th class="thEdit Rt mandatory">Subject</th>
			<td class="tdEdit" colspan="3">
				<ui:text name="articleSubject" checkName="Subject" options="mandatory"/>
			</td>
		</tr>
		<tr>
