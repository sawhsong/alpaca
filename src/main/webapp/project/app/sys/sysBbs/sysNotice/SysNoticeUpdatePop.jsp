...
<%
	...
	SysBoard sysBoard = (SysBoard)pe.getObject("sysBoard");
...
<div id="divDataArea" class="areaContainerPopup">
	<table class="tblEdit">
		...
		<tr>
			<th class="thEdit Rt mandatory">Writer</th>
			<td class="tdEdit">
				<ui:text name="writerName" value="<%=sysBoard.getWriterName()%>" checkName="Writer" options="mandatory"/>
			</td>
			<th class="thEdit Rt mandatory">Email</th>
			<td class="tdEdit">
				<ui:text name="writerEmail" value="<%=sysBoard.getWriterEmail()%>" checkName="Email" option="email" options="mandatory"/>
			</td>
		</tr>
		<tr>
			<th class="thEdit Rt mandatory">Subject</th>
			<td class="tdEdit" colspan="3">
				<ui:text name="articleSubject" value="<%=sysBoard.getArticleSubject()%>" checkName="Subject" options="mandatory"/>
			</td>
		</tr>
		<tr>
...
%>
		...
		<tr>
			<th class="thEdit Rt">
				Attached File<br/><br/>
				<div id="divButtonAreaRight">
					<ui:button id="btnAddFile" caption="button.com.add"/>
				</div>
			</th>
			<td class="tdEdit" colspan="3">
