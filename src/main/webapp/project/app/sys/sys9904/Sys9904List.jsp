			...
			<table class="tblDefault">
				...
				<tr>
					...
					<td class="tdDefault">
						...
						<ui:text name="fromDate" className="Ct hor" style="width:100px" checkName="sys9904.search.searchDateFrom" option="date"/>
						<ui:icon id="icnFromDate" className="fa-calendar hor" title="sys9904.search.searchDateFrom"/>
						<div class="horGap20" style="padding:6px 8px 6px 0px;">-</div>
						<ui:text name="toDate" className="Ct hor" style="width:100px" checkName="sys9904.search.searchDateTo" option="date"/>
						<ui:icon id="icnToDate" className="fa-calendar hor" title="sys9904.search.searchDateTo"/>
					</td>
				</tr>
			</table>
		</div>
