...
<div id="divDataArea" class="areaContainerPopup">
	...
	<table class="tblEdit">
		...
		<tr>
			...
			<th class="thEdit rt">Login Password</th>
			<td class="tdEdit">************</td>
		</tr>
		<tr>
			<th class="thEdit rt">Startup URL</th>
			<td class="tdEdit"><%=sysUser.getDefaultStartUrl()%></td>
			<th class="thEdit rt">Authority Group</th>
		...
		<tr>
			<th class="thEdit rt">User Type</th>
			<td class="tdEdit"><%=CommonCodeManager.getCodeMeaning("USER_TYPE", sysUser.getUserType())%></td>
		...
		<tr>
			<th class="thEdit rt">User Status</th>
