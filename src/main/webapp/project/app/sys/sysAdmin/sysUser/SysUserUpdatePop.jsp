...
<div id="divDataArea" class="areaContainerPopup">
			...
			<table class="tblDefault">
				<tr>
					<td class="tdDefaultCt">
						<img id="img<%=sysUser.getUserId()%>" src="<%=sysUser.getPhotoPath()%>" class="imgDis" style="width:90px;height:90px;"/>
					</td>
				</tr>
			</table>
		</div>
	...
	<table class="tblEdit">
		...
		<tr>
			...
			<td class="tdEdit"><ui:password name="password" value="************" checkName="Login Password" options="mandatory" status="display"/></td>
		</tr>
		<tr>
			<th class="thEdit rt mandatory">Startup URL</th>
			<td class="tdEdit"><ui:text name="defaultStartUrl" value="<%=sysUser.getDefaultStartUrl()%>" checkName="Startup URL" options="mandatory"/></td>
			<th class="thEdit rt mandatory">Authority Group</th>
			<td class="tdEdit"><ui:select name="authGroup" checkName="Authority Group" options="mandatory"> </ui:select></td>
		</tr>
		<tr>
			<th class="thEdit rt mandatory">Language</th>
			<td class="tdEdit"><ui:ccselect name="language" codeType="LANGUAGE_TYPE" selectedValue="<%=sysUser.getLanguage()%>" options="mandatory"/></td>
			<th class="thEdit rt mandatory">Theme Type</th>
			<td class="tdEdit"><ui:ccselect name="themeType" codeType="USER_THEME_TYPE" selectedValue="<%=sysUser.getThemeType()%>" options="mandatory"/></td>
		</tr>
		<tr>
			<th class="thEdit rt mandatory">User Type</th>
			<td class="tdEdit"><ui:ccselect name="userType" codeType="USER_TYPE" selectedValue="<%=sysUser.getUserType()%>" options="mandatory"/></td>
			<th class="thEdit rt mandatory">Email</th>
			<td class="tdEdit"><ui:text name="email" value="<%=sysUser.getEmail()%>" checkName="Email" options="mandatory" option="email"/></td>
		</tr>
		<tr>
