...
<div id="divDataArea" class="areaContainerPopup">
	<table class="tblEdit">
		...
		<tr>
			...
			<td class="tdEdit">
				<ui:text id="writerName" name="writerName" className="defClass" value="<%=sysUser.getUserName()%>" checkName="sys0602.header.writerName" options="mandatory"/>
			</td>
			<th class="thEdit Rt mandatory"><mc:msg key="sys0602.header.writerEmail"/></th>
			<td class="tdEdit">
				<ui:text id="writerEmail" name="writerEmail" className="defClass" value="<%=sysUser.getEmail()%>" checkName="sys0602.header.writerEmail" option="email" options="mandatory"/>
			</td>
		</tr>
		<tr>
			<th class="thEdit Rt mandatory"><mc:msg key="sys0602.header.articleSubject"/></th>
			<td class="tdEdit" colspan="3">
				<ui:text id="articleSubject" name="articleSubject" className="defClass" checkName="sys0602.header.articleSubject" options="mandatory"/>
			</td>
		</tr>
		<tr>
		...
		<tr>
			<th class="thEdit Rt">
				<mc:msg key="sys0602.header.attachedFile"/><br/>
				<div id="divButtonAreaRight">
