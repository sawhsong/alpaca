...
<div id="divDataArea" class="areaContainerPopup">
	<table class="tblEdit">
		<caption class="captionDefault"><mc:msg key="sys9804.header.gstAmount"/></caption>
		<colgroup>
			<col width="25%"/>
			<col width="25%"/>
			<col width="25%"/>
		...
		<tr>
			...
			<th class="thEdit Ct mandatory"><mc:msg key="sys9804.header.to"/></th>
			<th class="thEdit Ct"><mc:msg key="sys9804.header.invoiceAmount"/></th>
			<th class="thEdit Ct"><mc:msg key="sys9804.header.total"/></th>
		</tr>
		<tr>
