...
<div id="divButtonArea" class="areaContainerPopup">
	...
	<div id="divButtonAreaRight">
		<ui:buttonGroup id="buttonGroup">
			<ui:button id="btnUnlock" caption="Unlock" iconClass="fa-unlock-alt"/>
...
%>
			<tr>
				<td class="tdGrid Ct"><input type="checkbox" name="chkForAction" class="chkEn inTblGrid" value="<%=prtSetup.getValue(i, "ASSIGNMENT_ID")%>"/></td>
