...
<div id="divInformArea" class="areaContainerPopup">
	<table class="tblEdit">
		...
		<tr>
			...
			<td class="tdEdit"><ui:text name="codeMeaningMaster" value="<%=resultDataSet.getValue(masterRow, \"CODE_MEANING\")%>" checkName="sys0202.header.codeMeaning" options="mandatory"/></td>
...
<li id="liDummy" class="dummyDetail">
	<table class="tblGrid" style="border:0px">
		...
		<tr class="noBorderAll">
			...
			<td class="tdGrid ct"><ui:text name="codeMeaningDetail" checkName="sys0202.header.codeMeaning" options="mandatory"/></td>
