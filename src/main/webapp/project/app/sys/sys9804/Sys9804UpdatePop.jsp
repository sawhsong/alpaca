...
<div id="divDataArea" class="areaContainerPopup">
	<table class="tblEdit">
		...
		<tr>
			<th class="thEdit Rt mandatory"><mc:msg key="sys9804.header.writerName"/></th>
			<td class="tdEdit">
				<ui:text name="writerName" value="<%=sysBoard.getWriterName()%>" checkName="sys9804.header.writerName" options="mandatory"/>
			</td>
			<th class="thEdit Rt mandatory"><mc:msg key="sys9804.header.writerEmail"/></th>
			<td class="tdEdit">
				<ui:text name="writerEmail" value="<%=sysBoard.getWriterEmail()%>" checkName="sys9804.header.writerEmail" option="email" options="mandatory"/>
			</td>
		</tr>
		<tr>
			<th class="thEdit Rt mandatory"><mc:msg key="sys9804.header.articleSubject"/></th>
			<td class="tdEdit" colspan="3">
				<ui:text name="articleSubject" value="<%=sysBoard.getArticleSubject()%>" checkName="sys9804.header.articleSubject" options="mandatory"/>
			</td>
		</tr>
		<tr>
		...
		<tr>
			<th class="thEdit Rt">
				<mc:msg key="sys9804.header.attachedFile"/><br/>
			</th>
			<td class="tdEdit" colspan="3">
