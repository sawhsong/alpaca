<%@page import="project.common.module.constantshelper.ConstantsHelper"%>
<%/************************************************************************************************
...
<%
	...
	boolean isEcmsEboTabAvailable = false, isPortalTabAvailable = ConstantsHelper.hasPortalTab(personType);

	if (CommonUtil.containsIgnoreCase(personType, "ECMS", "NZ", "UOM")) {
		isEcmsEboTabAvailable = true;
		captionEcmsEbo = "ECMS";
	} else if (CommonUtil.containsIgnoreCase(personType, "EBO", "EES")) {
		isEcmsEboTabAvailable = true;
		captionEcmsEbo = "EBO";
	}
%>
