...
<div id="divInformArea" class="areaContainerFrame">
	<div id="divPersonHeader" class="alert alert-info personInfoHeader"><%=hpPersonD.getFullName()%> (<%=hpPersonD.getPersonNumber()%>) <%=hpPersonD.getPersonType()%></div>
</div>
<%/************************************************************************************************
* End of fixed panel
************************************************************************************************/%>
					...
					<table id="tblPersonDetails" class="tblEdit">
						...
						<tbody>
							...
							<tr>
								...
								<td class="tdEdit"><ui:ccradio name="maritalStatus" codeType="MARITAL_STATUS" isCustomised="true"/></td>
							</tr>
							<tr>
							...
							<tr>
								<th class="thEdit rt">Aboriginal or Torres Strait Islander decent?</th>
								<td class="tdEdit"><ui:ccradio name="isAorTsi" codeType="SIMPLE_YN" isCustomised="true"/></td>
							</tr>
							<tr>
...
<%-- 					<ui:txa name="commsHistory" style="height:299px;border:1px solid #cccccc;border-radius:3px" status="display"/> --%>
					<div id="commsHistory" style="padding:6px;height:300px;border:1px solid #cccccc;border-radius:3px;overflow:auto;line-height:150%;"></div>
				</div>
			</div>
		</div>
	</div>
