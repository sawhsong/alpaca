	...
	<div class="panel panel-default">
		<div class="panel-body">
			<table class="tblDefault">
				...
				<tr>
					<td class="tdDefault">
						<label for="searchType" class="lblEn hor"><mc:msg key="per0402.search.searchType"/></label>
					...
					<td class="tdDefault">
						<label for="fromDate" class="lblEn hor"><mc:msg key="per0402.search.searchPeriod"/></label>
						<ui:text id="fromDate" name="fromDate" className="defClass Ct hor" style="width:100px" checkName="per0402.search.searchDateFrom" option="date"/>
						<ui:icon id="icnFromDate" className="fa-calendar icnEn hor" title="per0402.search.searchDateFrom"/>
						<div class="horGap20" style="padding:6px 8px 6px 0px;">-</div>
						<ui:text id="toDate" name="toDate" className="defClass Ct hor" style="width:100px" checkName="per0402.search.searchDateTo" option="date"/>
						<ui:icon id="icnToDate" className="fa-calendar icnEn hor" title="per0402.search.searchDateTo"/>
					</td>
				</tr>
			</table>
		</div>
	...
	<table id="tblGrid" class="tblGrid sort autosort">
		...
		<thead>
			<tr class="noBorderHor">
				...
				<th class="thGrid sortable:alphanumeric"><mc:msg key="per0402.grid.subject"/></th>
				<th class="thGrid"><mc:msg key="per0402.grid.file"/></th>
				<th class="thGrid sortable:alphanumeric"><mc:msg key="per0402.grid.writerName"/></th>
				<th class="thGrid sortable:date"><mc:msg key="per0402.grid.date"/></th>
				<th class="thGrid sortable:numeric"><mc:msg key="per0402.grid.hitCount"/></th>
