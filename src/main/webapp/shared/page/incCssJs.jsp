...
<link type="text/css" rel="stylesheet" href="<mc:cp key="fontas"/>/css/font-awesome.css"/>
...
<script type="text/javascript" src="<mc:cp key="jsCommon"/>/paging.js"></script>
<script type="text/javascript" src="<mc:cp key="jsCommon"/>/freezeHeader.js"></script>
<script type="text/javascript" src="<mc:cp key="jsCommon"/>/dataGrid.js"></script>
