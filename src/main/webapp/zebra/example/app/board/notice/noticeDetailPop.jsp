...
<%
	...
	ZebraBoard noticeBoard = (ZebraBoard)paramEntity.getObject("noticeBoard");
	...
	<table class="tblEdit">
		...
		<tr>
			...
			<td class="tdEdit" colspan="3" style="height:226px;vertical-align:top;">
				<ui:txa style="height:210px;padding:0px 4px 0px 0px" value="<%=noticeBoard.getArticleContents()%>" status="display"/>
			</td>
		</tr>
		<tr>
